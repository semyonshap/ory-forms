...
import { removeEmptyStrings } from "../../../shared/util/removeFalsyValues"
import { computeDefaultValues } from "../util/form-helpers"
  ...
  const onSubmit: SubmitHandler<FormValues> = async (initialData) => {
    ...
    switch (flowContainer.flowType) {
      ...
      case FlowType.OAuth2Consent: {
        await onSubmitConsent(flowContainer, config, {
          body: data as unknown as UpdateConsentBody,
          onRedirect,
        })
        break
      }
