import { OrySettingsPasskeyProps } from "@/features/ory-elements"
import { Key as Passkey, Trash2 as Trash } from "lucide-react"
    ...
    <div className="flex flex-col gap-8">
      <div className="flex max-w-[60%] items-end gap-3">
        {triggerButton && (
          ...
          >
            {triggerButton.meta.label?.text || "Add Passkey"}
          </Button>
        )}
      </div>
      {hasRemoveButtons ? (
